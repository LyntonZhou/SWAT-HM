...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      if (eof < 0) exit
!      added by Zhou 20160107
      read (104,5100,iostat=eof) titldum
      if (eof < 0) exit
      read (104,*,iostat=eof) chhml_stl(1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) chhml_rsp(1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) chhml_mix(1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) sedhml_bry(1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) sedhml_conc(3,1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) sedhml_conc(4,1,irch)
      if (eof < 0) exit
      read (104,*,iostat=eof) sedhml_act(irch)
      if (eof < 0) exit
