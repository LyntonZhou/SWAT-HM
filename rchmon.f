...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
 ...
 !! added NO3 Concentration to output.rch (for daily only) gsm 10/26/2011
         ...
         pdvar(43) = hmlrchmono(9,1,j)   
         pdvar(44) = hmlrchmono(11,1,j)
         pdvar(45) = hmlrchmono(12,1,j)
         pdvar(46) = hmlrchmono(9,1,j) 
     &   + hmlrchmono(11,1,j) + hmlrchmono(12,1,j)
 ...
 !    &                                    (pdvr(ii), ii = 1, itotr), j
          write (7,5000) j, iyr, mo_chk, rch_dakm(j),           
     &                                    (pdvr(ii), ii = 1, itotr), j
     ...
     &             hmlrchmono(4,1:mhml-1,j),               
     &             hmlrchmono(9,1:mhml-1,j),   
     &             hmlrchmono(10,1:mhml-1,j),
     &             hmlrchmono(12,1:mhml-1,j),
     &             hmlrchmono(5,1:mhml-1,j),
     &             hmlrchmono(6,1:mhml-1,j),
     &             hmlrchmono(7,1:mhml-1,j),
     &             hmlrchmono(8,1:mhml-1,j),
