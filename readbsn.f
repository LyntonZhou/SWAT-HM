...
!! read basin parameters
      ...
      !! added by Zhou 20150724
       ! Set percolation of metal from 1cm surface soil to 1st layer soil as that of pesticide
	percohml=percop	! Actually such a adjustment factor to differentiate 
	                ! the concentrationb between percolation and surface runoff is lacking
					! scientific support
	percohml=1.0	! For aqueous metals, I think percolation should has the 
					! same concentration as runoff 
      ...
      read (103,*) wdlpf
      read (103,*) wglpf
      !! added by Zhou 20151117
      read (103,*) ised_det
      !read (103,1001) ised_det
      !! read ised_det incorrectly 
      read (103,1000) titldum
      read (103,*) irte
      read (103,*) msk_co1
      read (103,*) msk_co2
