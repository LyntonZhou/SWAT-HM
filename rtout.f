...
!!    sediment routing
      ...
      if (ievent == 0) then
       ...
       varoute(16,ihout) = rch_cbod(jrch) *  rtwtr/ 1000.
          ...
          !! H.metal outflow
          do k = 1, n_hml_mx
              hmlroute(1,k,ihout) = hml_sol_o(k)  * rtwtr
              hmlroute(2,k,ihout) = hml_lig_o(k)  * rtwtr
              hmlroute(3,k,ihout) = hml_exch_o(k) * rtwtr
              hmlroute(4,k,ihout) = hml_nlab_o(k) * rtwtr
          end do
...
!          hhvaroute(3,ihout,ii) = hsedyld(ii)
          ...
          hhvaroute(22,ihout,ii) = hhvaroute(22,inum2,ii) * (1. - rnum1)
              ...
              !! H.metal outflow
          do k = 1, n_hml_mx
              hhhmlroute(1,k,ihout,ii) = hhhml_sol_o(k,ii)  * hrtwtr(ii)
              hhhmlroute(2,k,ihout,ii) = hhhml_lig_o(k,ii)  * hrtwtr(ii)
              hhhmlroute(3,k,ihout,ii) = hhhml_exch_o(k,ii) * hrtwtr(ii)
              hhhmlroute(4,k,ihout,ii) = hhhml_nlab_o(k,ii) * hrtwtr(ii)
          end do
          ...
          varoute(17,ihout) = varoute(17,ihout) + hhvaroute(17,ihout,ii)
              ...
              !! H.metal outflow
      do k = 1, n_hml_mx
      hmlroute(1,k,ihout)=hmlroute(1,k,ihout)+hhhmlroute(1,k,ihout,ii)
      hmlroute(2,k,ihout)=hmlroute(2,k,ihout)+hhhmlroute(2,k,ihout,ii)
      hmlroute(3,k,ihout)=hmlroute(3,k,ihout)+hhhmlroute(3,k,ihout,ii)
      hmlroute(4,k,ihout)=hmlroute(4,k,ihout)+hhhmlroute(4,k,ihout,ii)
      end do
...
!!    H.metal routing 	
          do k = 1, n_hml_mx
              hmlrchdy(1,k,jrch) = hmlroute(1,k,inum2) * (1. -rnum1) !!soluble hml in
              hmlrchdy(2,k,jrch) = hmlroute(2,k,inum2) * (1. -rnum1) !!ligand-bnd hml in
              hmlrchdy(3,k,jrch) = hmlroute(3,k,inum2) * (1. -rnum1) !! labile hml in
              hmlrchdy(4,k,jrch) = hmlroute(4,k,inum2) * (1. -rnum1) !!N-labile hml in

              if (sum(hmlrchdy(1:4, k,jrch),dim=1)<0.) then
                  hmlrchdy(1,k,jrch)=-99.
              end if

              hmlrchdy(5,k,jrch) = setlhml_nlab(k)+setlhml_exch(k)	!! Settled Metal
              hmlrchdy(6,k,jrch) = rsushml_nlab(k)+rsushml_exch(k)	!! Resuspended Metal
              hmlrchdy(7,k,jrch) = bury_nlab(k)+bury_exch(k)       	!! Buried Metal
              hmlrchdy(8,k,jrch) = -difus_hml(k)                      !! Diffuse to sed
              hmlrchdy(9,k,jrch)  = hmlroute(1,k,ihout)				!! soluble hml out
              hmlrchdy(10,k,jrch) = hmlroute(2,k,ihout)				!! ligand-bnd hml out
              hmlrchdy(11,k,jrch) = hmlroute(3,k,ihout)				!!  labile hml out
              hmlrchdy(12,k,jrch) = hmlroute(4,k,ihout)				!! N-labile hml out
              !! added by Zhou 20171026, heavy emtal in sediment
              hmlrchdy(13,k,jrch) = sedhml_conc(1,k,jrch)
              hmlrchdy(14,k,jrch) = sedhml_conc(2,k,jrch)
              hmlrchdy(15,k,jrch) = sedhml_conc(3,k,jrch)
              hmlrchdy(16,k,jrch) = sedhml_conc(4,k,jrch)
          end do
...
!!    sediment routing
          ...
          !! added by Zhou 20180126
      do k = 1, n_hml_mx
              
         hmlrchmono(1,k,jrch)=hmlrchmono(1,k,jrch)+hmlrchdy(1,k,jrch)
         hmlrchmono(2,k,jrch)=hmlrchmono(2,k,jrch)+hmlrchdy(2,k,jrch)
         hmlrchmono(3,k,jrch)=hmlrchmono(3,k,jrch)+hmlrchdy(3,k,jrch)
         hmlrchmono(4,k,jrch)=hmlrchmono(4,k,jrch)+hmlrchdy(4,k,jrch)
         hmlrchmono(5,k,jrch)=hmlrchmono(5,k,jrch)+hmlrchdy(5,k,jrch)
         hmlrchmono(6,k,jrch)=hmlrchmono(6,k,jrch)+hmlrchdy(6,k,jrch)
         hmlrchmono(7,k,jrch)=hmlrchmono(7,k,jrch)+hmlrchdy(7,k,jrch)
         hmlrchmono(8,k,jrch)=hmlrchmono(8,k,jrch)+hmlrchdy(8,k,jrch)
         hmlrchmono(9,k,jrch)=hmlrchmono(9,k,jrch)+hmlrchdy(9,k,jrch)
         hmlrchmono(10,k,jrch)=hmlrchmono(10,k,jrch)+hmlrchdy(10,k,jrch)
         hmlrchmono(11,k,jrch)=hmlrchmono(11,k,jrch)+hmlrchdy(11,k,jrch)
         hmlrchmono(12,k,jrch)=hmlrchmono(12,k,jrch)+hmlrchdy(12,k,jrch)
         hmlrchmono(13,k,jrch)=hmlrchmono(13,k,jrch)+hmlrchdy(13,k,jrch)
         hmlrchmono(14,k,jrch)=hmlrchmono(14,k,jrch)+hmlrchdy(14,k,jrch)
         hmlrchmono(15,k,jrch)=hmlrchmono(15,k,jrch)+hmlrchdy(15,k,jrch)
         hmlrchmono(16,k,jrch)=hmlrchmono(16,k,jrch)+hmlrchdy(16,k,jrch)
