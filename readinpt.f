...
!!    hmlflg(:)     |none          |array defining different heavy metals
!!                                 |used in the watershed
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!! added by Zhou 2015/7/1      
      n_hml_mx = 0
	n_hml_mx = sum (hmlflg)    !! total number of heavy metal in the whole watershed

      do i = 1, nhru
        !call soil_par
        call soil_chem           !! initialize soil chemical parameters
        call soil_phys           !! initialize soil physical parameters
        call soil_chem_hml       !! initialize soil metals' parameters
      end do
