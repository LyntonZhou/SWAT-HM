...
!!    mhml        |none        |max number of heavy metals used in wshed
!!    mhmldb		|none		 |max number of heavy metals in metals.dat
...
!!                             |1: pesticide used
!!    hmlflg(:)   |none        |flag for types of heavy metals input in watershed
!!                             |array location is pesticide ID number
!!                             |0: heavy metal not inputted
!!                             |1: heavy metal inputted
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &                      fertdb, subfile, fcstfile, bsnfile, metaldb
      character (len=1) ::  a
...
!     septic database file
      ...
      !! Heavy metals' database name is not read in here to maintain the integrity of file.cio.
	metaldb="metal.dat"
...
!! calculate number of records in heavy metals' database
      eof = 0
      mhmldb = 0
      open (34,file=metaldb)
      do
        ipnum = 0
        read (34,6200,iostat=eof) ipnum
        if (eof < 0) exit
        mhmldb = Max(mhmldb,ipnum)
      end do
      close (34)
      if (mhmldb <= 0) mhmldb = 1
