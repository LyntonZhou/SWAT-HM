...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &    pestdb, fertdb, fcstfile,metaldb
...
!       itoth = mhruo
      ...
      open (33, file="output.hml",recl=8000)
      
      !! added by Zhou 20150723
	open (303,file="outhml.hru",recl=8000)
      open (304,file="outhml.wtr",recl=8000)
      open (305,file="outhml.pst",recl=8000)
      open (306,file="outhml.sub",recl=8000)
      open (307,file="outhml.rch",recl=8000)
      open (308,file="outhml.rsv",recl=8000)
