...
!! arrays
  ...
  !!    orig_tnylda = tnylda
      ...
      !Store those for heavy metals
	orig_lkhmlconc=lkhml_conc
!	orig_lkshmlconc=lkshml_conc   ! In fact, lkshhml_conc is not used, lksedhml_conc is used instead 
	orig_sedhmlconc=lksedhml_conc

      orig_solhml_sol=sol_hml_sol   ! Soluable
      orig_solhml_lig=sol_hml_lig   ! Ligand-fixed
      orig_solhml_exch=sol_hml_lab !  labile in soil
      orig_solhml_nlab=sol_hml_nlab ! Non-labile in soil
