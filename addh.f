...
!! add loadings and store in new hydrograph location
     ...
     &                             (varoute(2,inum1) + varoute(2,inum2))
      ...
      !! For H.metal merging
	do k = 1, mhml
	  hmlroute(1,k,ihout) = hmlroute(1,k,inum1) + hmlroute(1,k,inum2)
	  hmlroute(2,k,ihout) = hmlroute(2,k,inum1) + hmlroute(2,k,inum2)
	  hmlroute(3,k,ihout) = hmlroute(3,k,inum1) + hmlroute(3,k,inum2)
	  hmlroute(4,k,ihout) = hmlroute(4,k,inum1) + hmlroute(4,k,inum2)
		
		if (hmlroute(1,k,ihout)<0.) then
			hmlroute(1,k,ihout)=-99.
		end if
...
!! add hydrograph points (hourly time step)
   ...
   !       do kk = 1, 24
     ...
     *                                            hhvaroute(ii,inum2,kk)
        !! added by Zhou 20150723    
            do k = 1, mhml
		  hhhmlroute(1,k,ihout,ii) = hhhmlroute(1,k,inum1,ii)
     &		   + hhhmlroute(1,k,inum2,ii)
		  hhhmlroute(2,k,ihout,ii) = hhhmlroute(2,k,inum1,ii)
     &		   + hhhmlroute(2,k,inum2,ii)
		  hhhmlroute(3,k,ihout,ii) = hhhmlroute(3,k,inum1,ii)
     &		   + hhhmlroute(3,k,inum2,ii)
		  hhhmlroute(4,k,ihout,ii) = hhhmlroute(4,k,inum1,ii)
     &		   + hhhmlroute(4,k,inum2,ii)
		end do
