...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !! added by Zhou 20160904
      pdvab(10) = sub_sedy(sb)
      ...
      !! added by Zhou 20190313
      pdvab(23) = sub_hml_sol(1,sb,1)
...
!!    added for binary files 3/25/09 gsm line below and write (6666
     ...
     &                                        (pdvab(ii), ii = 1, msubo)
      ...
      !! added by Zhou 20150723 20171223
      !! Write H.metal     
      write (306, 1002) sb, iyr, iida, sub_km(sb),
     ...
     &    (sub_hml_weth(k,sb),k=1, n_hml_mx),
     &    (sub_hml_agr(k,sb),k=1, n_hml_mx),     
     &    (sub_hml_sol(k,sb,1)+sub_hml_sol(k,sb,2)
     &     +sub_hml_sol(k,sb,3)+sub_hml_sol(k,sb,4)+
     &     sub_hml_exch(k,sb)+sub_hml_nlab(k,sb), k=1, n_hml_mx),
     &    (sub_hml_dep(k,sb)+sub_hml_weth(k,sb)+sub_hml_agr(k,sb),
     &     k=1, n_hml_mx)
